        ...
        <div className={styles.container}>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.contentText}>
                    ...
                    <p>
                        超级锦鲤奖：抽中6.6元红包的用户可选择放弃红包兑换V卡，凭V卡可参与超级锦鲤奖抽奖活动，有机会获得vivo全家桶
                        (含vivo X60手机+vivo WATCH智能手表+ vivo TWS Neo真无线耳机)
                    </p>
                    <p>
                    ...
                    <p>
                        如因不可抗力因素
                        (包括不限于重大自然灾害事件、政府主管部门指令停止举办或遭受严重网络攻击、系统故障等)
                        导致本活动无法继续举办的，vivo可决定暂停或终止活动。
                    </p>
